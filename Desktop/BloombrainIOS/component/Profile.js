...
class Profile extends Component {
    ...
    render() {
        ...
        return (
            ...
            >
                <ScrollView>
                <View style = {{backgroundColor: "#0E0E0E", flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center'}} >
                    <TouchableOpacity>
                ...
                <View style = {{backgroundColor: "#0E0E0E", height: '20%', width: Dimensions.get('window').width, flexDirection: 'row', marginTop: 15, marginRight: 30, height: 140}}>
                    <View style = {{
                        alignItems: 'center',
                        marginLeft: 30
                    }}>
                    ...
                    <View
                        style = {{marginLeft: 30, marginTop: 23}}    
                    >
                        <Text style = {{
                            fontFamily: 'poppinsBold',
                            color: 'white',
