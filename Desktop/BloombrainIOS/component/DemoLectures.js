...
class DemoLectures extends Component {
    ...
    render() {
        return (
            <ScrollView style = {{paddingTop: 10, backgroundColor: '#101010', height: Platform.OS == 'ios' ? '85%' : '84%'}}>
                        ...
                        if(this.state.classes[val]){
                            return (
                                <View>
                                    ...
                                    <Text style = {{fontSize: 14, color: '#4ACDF4', marginLeft: 16, marginTop: -25, width: 250, fontFamily: 'poppinsBold'}}>Later</Text>}
                                    <FlatList 
                            ...
                            return(
                                <View>
                                    ...
                                    <Text style = {{fontSize: 12, color: 'white', marginLeft: 16, marginBottom: 40, fontFamily: 'poppinsSemiBold'}}>No Videos Found</Text>
                                </View>
                            )
